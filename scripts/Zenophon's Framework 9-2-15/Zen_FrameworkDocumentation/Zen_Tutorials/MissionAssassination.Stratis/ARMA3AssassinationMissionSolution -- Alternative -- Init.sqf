...
0 = [_InnerGuard, "AutoRifleman"] call Zen_GiveLoadoutOpfor;
...
0 = [_OuterGuard, "AutoRifleman"] call Zen_GiveLoadoutOpfor;
...
// Spawn a trigger inline
0 = [] Spawn{
	waituntil { sleep 2; X11 Distance BLUFORAmmo < 2 };
	0 = [X11, "AutoRifleman"] call Zen_GiveLoadoutBlufor;
};
...
// Insert an OPFOR squad riding in a truck
_VehiclePosition = ["Destination", [400, 550], [], 0, [1,200], [0, 90]] call Zen_FindGroundPosition;
_Zamak = [_VehiclePosition, "O_Truck_02_covered_F", 270] call Zen_SpawnGroundVehicle;
_ReactionGroup = [[0,0,0], EAST, "infantry", [3,5]] call Zen_SpawnInfantry;
0 = [_ReactionGroup, _Zamak] call Zen_MoveInVehicle;
0 = [_Zamak, ["Destination", "Destination"], _ReactionGroup, "limited"] spawn Zen_OrderInsertion;
